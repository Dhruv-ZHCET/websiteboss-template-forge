...
const TemplateEditor = () => {
 ...
 <p className="text-gray-600 dark:text-gray-300 text-lg font-medium">Loading your template...</p>
 <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">Preparing the magic ✨</p>
 </div>
 </div>
 );
 }
 ...
 <p className="text-gray-600 dark:text-gray-300 text-lg font-medium mb-4">Template not found</p>
 ...
 <span className="text-sm text-gray-700 dark:text-gray-300 font-medium">{template.name}</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-sm font-medium text-blue-700 dark:text-blue-300">Template Editor</span>
 </div>
 <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
 Customize Your Website
 </h1>
 <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
 Make your website unique by customizing colors, content, and images. Your changes are saved automatically.
 </p>
 </div>
 ...
 <Label htmlFor="businessName" className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center space-x-2">
 ...
 <div className="space-y-2">
 <Label htmlFor="tagline" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Tagline</Label>
 <Input
 id="tagline"
 ...
 {customData.logo ? (
 <div className="space-y-4">
 <img src={customData.logo} alt="Logo" className="w-32 h-20 object-cover rounded-lg mx-auto shadow-md" />
 <Button
 variant="outline"
 size="sm"
 onClick={() => setCustomData(prev => ({ ...prev, logo: '' }))}
 ...
 <div>
 <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Upload your logo</p>
 ...
 <div className="space-y-4">
 <img src={customData.heroImage} alt="Hero" className="w-full h-32 object-cover rounded-lg shadow-md" />
 <Button
 variant="outline"
 size="sm"
 onClick={() => setCustomData(prev => ({ ...prev, heroImage: '' }))}
 className="text-red-600 hover:text-red-700 hover:bg-red-50"
 >
 Remove Image
 </Button>
 ...
 <div>
 <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Upload hero image</p>
 <p className="text-xs text-gray-500 dark:text-gray-400">PNG, JPG up to 5MB</p>
 </div>
 </div>
 )}
 ...
 <Label htmlFor="primaryColor" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Primary Color</Label>
 ...
 <div className="space-y-3">
 <Label htmlFor="secondaryColor" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Secondary Color</Label>
 <div className="flex items-center space-x-4">
 <div
 className="w-16 h-12 rounded-lg border-2 border-gray-200 dark:border-gray-600 shadow-inner"
 ...
 <Button onClick={addProduct} className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white shadow-lg">
 ...
 <div key={index} className="border-2 border-gray-200 dark:border-gray-600 rounded-xl p-6 space-y-4 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-700">
 <div className="flex justify-between items-center">
 ...
 {product.image ? (
 <div className="space-y-3">
 <img src={product.image} alt="Product" className="w-24 h-24 object-cover rounded-lg mx-auto shadow-md" />
 <Button
 variant="outline"
 size="sm"
 ...
 <p className="text-sm text-gray-500 dark:text-gray-400">Upload product image</p>
 </div>
 )}
 <Input
 type="file"
 ...
 <Button onClick={addService} className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-lg">
 <Plus className="h-4 w-4 mr-2" />
 Add Service
 </Button>
 </div>
 ...
 <div key={index} className="border-2 border-gray-200 dark:border-gray-600 rounded-xl p-6 space-y-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
 <div className="flex justify-between items-center">
 <h4 className="font-semibold text-lg text-gray-900 dark:text-white flex items-center space-x-2">
 ...
 <div className="space-y-6">
 <div className="space-y-3">
 <Label htmlFor="facebook" className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center space-x-2">
 ...
 <div className="space-y-3">
 <Label htmlFor="instagram" className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center space-x-2">
 ...
 <div className="space-y-3">
 <Label htmlFor="twitter" className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center space-x-2">
 ...
 Adding social media links helps build trust with your customers and makes it easy for them to connect with you on their favorite platforms.
 </p>
 </div>
 </CardContent>
 </Card>
